package com.devsuperior.projetoCRUD.resources;
...
import com.devsuperior.projetoCRUD.services.ClientService;
...
public class ClientResources {
	...
	public ResponseEntity<ClientDTO> deletar(@PathVariable Long id){
		service.deletar(id);
